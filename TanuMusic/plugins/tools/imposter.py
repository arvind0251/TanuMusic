...
BUTTONS1 = [
    [
        ...
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇ", url=f"https://t.me/OfficialBUTTONS1aa")
    ],
]
...
""".format(
    ...
    if msg != "":
        await message.reply_photo(random.choice(BUTTONS), caption=msg, reply_markup=InlineKeyboardMarkup(BUTTONS1),)
